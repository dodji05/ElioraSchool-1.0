...
echo "<div style='margin-left:3em;'>\n";
	...
	echo "<div style='margin-left:3em;'>\n";
		echo "<p>Vous pouvez définir deux seuils d'alerte et leurs actions associées. Ces seuils s'appliquent aux tentatives d'intrusion effectuées par les utilisateurs de ElioraSchool. Chaque tentative a un niveau de gravité de 1 à 3 ; les seuils correspondent au cumul de ces niveaux de gravité pour un même utilisateur.</p>\n";
