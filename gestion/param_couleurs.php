...
// INSERT INTO droits VALUES ('/gestion/param_couleurs.php', 'V', 'F', 'F', 'F', 'F', 'F', 'F', 'Définition des couleurs pour ElioraSchool', '');
if (!checkAccess()) {
    header("Location: ../logout.php?auto=1");
    die();
}
...
//**************** EN-TETE *****************
$titre_page = "Couleurs et Modèles ElioraSchool";
...
<p>Définissez les couleurs pour l'interface ElioraSchool et gérez vos modèles.
