...
unset($reg_telephone);
$reg_telephone = isset($_POST["reg_telephone"]) ? $_POST["reg_telephone"] : NULL;
unset($reg_tlieu_naissance);
$reg_lieu_naissance = isset($_POST["reg_lieu_naissance"]) ? $_POST["reg_lieu_naissance"] : NULL;
unset($reg_mef_code);
	...
	*/
	...
	if (isset($_POST['is_posted']) and ($_POST['is_posted'] == "1")) {
		...
		if (($continue == 'yes') and (isset($reg_login))) {
					...
					if ($count == "0") {
						...
						*/
						$sql="INSERT INTO eleves SET
							...
							lieu_naissance='".$reg_lieu_naissance ."',
							login='".$reg_login."',
							sexe='".$reg_sexe."',
							naissance='".$reg_naissance."',
							elenoet = '".$reg_no_gep."',
			...
			$sql="UPDATE eleves SET date_sortie = '$date_de_sortie_eleve', date_entree = '$date_entree_eleve', no_gep = '$reg_no_nat', nom='$reg_nom',prenom='$reg_prenom',sexe='$reg_sexe',telephone='$reg_telephone',lieu_naissance='$reg_lieu_naissance',naissance='".$reg_naissance."', ereno='".$reg_resp1."', elenoet = '".$reg_no_gep."'";
...
if (isset($eleve_login)) {
	...
	$eleve_telephone = old_mysql_result($call_eleve_info, "0", "telephone");
...
if(($_SESSION['statut']=="administrateur")||($_SESSION['statut']=="scolarite")){
	...
	*/
	...
	echo "</tr>\n";
	echo "<tr>\n";
	echo "	<th style='text-align:left;'>Telephone : </th>\n";
	echo "	<td>";
	echo "<input type='text' name='reg_telephone' size='18' ";
	...
	echo "</tr>\n";
	echo "<tr>\n";
	echo "	<th style='text-align:left;'>Lieu de naissance : </th>\n";
	echo "	<td>";
	echo "<input type='text' name='reg_lieu_naissance' size='18' ";
		if (isset($eleve_lieu_naissance)) {
			echo "value=\"".$eleve_lieu_naissance."\"";
		}
		echo " onchange='changement();' />";
	echo "	</td>";
	echo "</tr>\n";
