  ...
  protected function administration() {
	if ($this->statutUtilisateur == 'administrateur'){
	  ...
	  $this->creeNouveauItem('/gestion/index.php',
			  "Gestion générale",
			  "Pour accéder aux outils de gestion (sécurité, configuration générale, bases de données, initialisation de ElioraSchool).");
	  ...
	  $this->creeNouveauItem('/a_lire.php',
			"À lire",
			"Quelques fichiers concernant ElioraSchool.");
  ...
  protected function modeleOpenOffice(){
	...
	if (getSettingValue("active_mod_ooo")=='y') {
	  ...
	  $this->creeNouveauItem("/mod_ooo/index.php",
			"Modèle Open Office",
			"Gérer les modèles Open Office dans ElioraSchool et Utiliser les formulaires de saisie");
	}
		...
		if (getSettingValue("rss_cdt_eleve") == 'y' AND $this->statutUtilisateur == "eleve") {
			...
			if (getSettingValue("rss_acces_ele") == 'direct') {
				...
				$this->canal_rss=array("lien"=>$uri_el["uri"] ,
										...
										<br />
										<br />
										<em style='font-size:small'>Avec cette URL, vous pourrez consulter les travaux à faire sans devoir vous connecter dans ElioraSchool.<br />Firefox, Internet Explorer,... savent lire les flux RSS.<br />Il existe également des lecteurs de flux RSS pour les SmartPhone,...</em>");
			}
