...
<!-- ================= Affichage du favicon 55555555555555555=================== -->
...
<?php
	...
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/core.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/components.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/colors.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/grid.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $racineGepi;?>/templates/limitless/assets/css/minified/doc.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->
<!-- Fin des styles -->
...
<!-- Début des fichiers en javascript -->
	...
	<!-- Core JS files -->
	<script type="text/javascript" src="<?php echo $racineGepi;?>/templates/limitless/assets/js/core/libraries/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo $racineGepi;?>/templates/limitless/assets/js/core/libraries/bootstrap.min.js"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<script type="text/javascript" src="<?php echo $racineGepi;?>/templates/limitless/assets/js/core/app.js"></script>
	<!-- /theme JS files -->
				...
				//if (1==1) {
				  if (seconds>=<?php echo $sessionMaxLength*60; ?>) {
				  	if (!warn_msg2_already_displayed) {
						var message = "vous avez été probablement déconnecté du serveur, votre travail ne pourra pas être enregistré dans ElioraSchool depuis cette page, merci de le sauvegarder dans un bloc note.";
