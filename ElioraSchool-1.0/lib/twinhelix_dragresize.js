...
//function DragResize(myName, config, chaine_handles)
function DragResize(myName, config, mode_handles)
{
 ...
 if(mode_handles=="") {
	...
	/*
	  handles: [ chaine_handles], // Array of drag handles: top/mid/bot/right.
	*/
	 ...
	 var props = {
	  myName: myName,                  // Name of the object.
	  enabled: true,                   // Global toggle of drag/resize.
	  handles: [ 'ml', 'mr'], // Array of drag handles: mid only.
	  isElement: null,                 // Function ref to test for an element.
	  isHandle: null,                  // Function ref to test for move handle.
	  element: null,                   // The currently selected element.
	  handle: null,                  // Active handle reference of the element.
