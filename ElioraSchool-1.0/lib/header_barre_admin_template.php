 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "administrateur") {
		...
		if(!getSettingAOui('gepi_en_production')) {
			...
			$menus .= '    <li><span title="Effacer la base : Choix désactivé sur un ElioraSchool en production.
                           Votre ElioraSchool est paramétré comme un ElioraSchool en production :
                           On ne vide normalement pas la base sur un ElioraSchool en production.
                           Si votre ElioraSchool est un ElioraSchool de test, vous pouvez modifier ce
                           paramétrage dans
...
Vous pouvez notamment faire apparaître un tableau des dates de conseils de classe.">Date événements</a></li>'."\n";
		...
		if(!getSettingAOui('gepi_en_production')) {
			...
			$menus .= '    <li><span title="Données de test : Choix désactivé sur un ElioraSchool en production.
                               Les données de test ajoutent des enregistrements dans la
                               base pour pouvoir tester ElioraSchool sans remplir soi-même la base.
                           
                               Votre ElioraSchool est paramétré comme un ElioraSchool en production :
                               Normalement, on n ajoute pas dans la base des données
                               de test sur un ElioraSchool en production.
                               Si votre ElioraSchool est un ElioraSchool de test, vous pouvez modifier ce
                               paramétrage dans
		...
		$menus .= '  <li><a href="'.$gepiPath.'/sms/index.php" '.insert_confirm_abandon().' title="Ce module permet d\'envoyer des sms aux éléves,aux personnels">SMS</a></li>'."\n";
		$menus .= '  <li><a href="'.$gepiPath.'/scolarite/index.php" '.insert_confirm_abandon().' title="Ce module permet d\'envoyer des sms aux éléves,aux personnels">Frais de scolarite</a></li>'."\n";
		$menus .= '  <li><a href="'.$gepiPath.'/paie_professeurs/index.php" '.insert_confirm_abandon().' title="Ce module permet d\'envoyer des sms aux éléves,aux personnels">Salaire des professeurs</a></li>'."\n";
