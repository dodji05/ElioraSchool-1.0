...
<h5 class="panel-title">Utilisateurs connectés</h5>
...
<div class="table-responsive">
	<table class=' table table-striped  '>
		<caption><span class='label label-info'>Utilisateurs connectés en ce moment<span></caption>
		<tr>
			<th>Utilisateur</th>
			<th>Statut</th>
...
<div class="panel panel-flat">
<div class="panel-heading">
<h5 class="panel-title">Activation/désactivation des connexions</h5>
<h2></h2>
...
<p>
	Configuration de ElioraSchool de manière à bloquer temporairement le compte d'un utilisateur après un certain nombre de tentatives 
...
<p>
	...
	sous réserve que leur adresse mail soit renseignée dans ElioraSchool (<em>information modifiable par le lien 'Gérer mon compte'</em>).
	<br />
...
<p>
	...
	sur votre ElioraSchool est: <span style='font-weight:bold'><?php echo $active_hostbyaddr; ?></span></p>
</div>
</div>
	<?php	
