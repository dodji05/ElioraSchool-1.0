...
?>
<H1 class='gepi'>Eliora School - Vie Privée</H1>
<?php
echo "<h2>Cadre légal</h2>";
echo "<p>Eliora School est un logiciel de traitement de données entrant dans le cadre des Environnements Numériques de Travail (ENT).";
...
echo "A chacune de vos visites Eliora School tente de générer un cookie de session. L'acceptation de ce cookie par votre navigateur est obligatoire pour accéder au site. Ce cookie de session est un cookie temporaire exigé pour des
