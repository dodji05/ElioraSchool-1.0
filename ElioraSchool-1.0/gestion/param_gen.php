...
(cahier de textes, absences,...)">
	...
	<p class="ligneCaps">
		<label for='gepiPrefixeSujetMail' class="cellTab70">
			Ajouter un préfixe au sujet des mails envoyés par ElioraSchool :<br />
			<span class="plusPetit">Cela peut être utile si vous recevez des mails de plusieurs ElioraSchool.<br />
			Notez que le préfixe 'ElioraSchool :' est de toutes façons ajouté.</span>
		</label>
		<span class="cellTab plusPetit">
	...
	<p class="ligneCaps">
		<label for='sessionMaxLength' class="cellTab70">
			...
			<span class='small'>(<em>Durée d'inactivité, en minutes, au bout de laquelle un utilisateur est automatiquement déconnecté de ElioraSchool.</em>) <b>Attention</b>, la variable <b>session.maxlifetime</b> dans le fichier <b>php.ini</b> est réglée à <?php 
	...
	<div style="display: table-row;">
		<div class="cellTab70">
			<p style="font-variant: small-caps;">
				...
				Mode d'ouverture des fichiers PDF produits par ElioraSchool&nbsp;:
			</p>
		</div>
		<p class="cellTab plusPetit">
<?php
...
if(!in_array($output_mode_pdf, array("D", "I"))) {$output_mode_pdf='D';}
 ?>
	...
	<p class="ligneCaps">
		<span class="cellTab70">
			<label for='url_racine_gepi' style='cursor: pointer'>Adresse de la racine ElioraSchool</label>
			<br />
			<span class='small'>
	...
	<p class="ligneCaps">
		<span class="cellTab70">
			<label for='url_racine_gepi_interne' style='cursor: pointer'>Adresse interne de la racine ElioraSchool</label>
			<br />
			<span class='small'>
				(<em>utilisé dans des envois de mails pour donner l'adresse d'une page en particulier<br />
				Exemple&nbsp;: https://IP_SERVEUR/DOSSIER_GEPI<br />
				Laisser vide si l'adresse interne d'accès à ElioraSchool est la même que l'adresse externe</em>)&nbsp;:
			</span>
		</span>
		<span class="cellTab plusPetit">
			<?php
	...
	<p class="ligneCaps">
		<span class="cellTab70">
			...
			<span class='small'>
				...
				installation de ElioraSchool doit faire l'objet d'une déclaration de traitement automatisé d'informations nominatives 
				de la CNIL. Si ce n'est pas encore le cas, laissez libre le champ ci-contre<br />
				<a href='http://www.sylogix.org/projects/ElioraSchool/wiki/Declaration_cnil' target='_blank'>Voir wiki</a>
			</span>
		</span>
		<span class="cellTab plusPetit">
			<input type="text" 
...
?>
	...
	<p  class="cellTab" style="font-variant: small-caps;">
		Tester la date de la révision ElioraSchool avec git<br />(<em>nécessite que git soit installé et accessible</em>) :
	</p>
	<p class="cellTab">
		<input type="radio" 
	...
	<p>
		git est l'outil de gestion de versions de ElioraSchool.<br />
		...
		Cela peut être commode pour apporter des précisions sur votre version quand vous posez une question sur la liste ElioraSchool-users, mais l'absence éventuelle de git n'enlèvera aucune fonctionnalité à votre ElioraSchool.
	</p>
</fieldset>
</form>
...
?>
	...
	<p  class="cellTab" style="font-variant: small-caps;">
		ElioraSchool en production<br />(<em>par opposition à un ElioraSchool de test</em>)&nbsp;:
	</p>
	<p class="cellTab">
		<input type="radio" 
	...
	<p>
		Sur un serveur ElioraSchool en production, avec des données que l'on ne veut pas perdre accidentellement, on désactive l'accès à quelques liens sensibles de ElioraSchool comme <strong>Effacer la base</strong> et <strong>Données de test</strong>.<br />
		Sur un ElioraSchool de test en revanche, on peut souhaiter effectuer ces actions sensibles.
	</p>
</fieldset>
</form>
	...
	<p class="ligneCaps" style="font-variant: small-caps;">
		Activer le debug PHPMailer&nbsp;:<br />
			<span class='small'>
				...
				Cette activation va polluer les affichages dans ElioraSchool<br />avec un grand nombre de lignes chaque fois qu'un mail est envoyé.<br />
...
?>
	...
	<p class='small' style="width: 60%;">Si la journalisation est activée alors les échanges entre ElioraSchool et le prestataire seront enregistrés dans un fichier 'envoi_SMS.log' placé dans le dossier des sauvegardes (dossier accessible via le menu Maintenance/Sauvegarde) ceci afin de résoudre d'éventuels problèmes. Pour ne pas saturer l'espace disque, ce fichier est vidé dès qu'il atteint la taille de 512 k0.</p>
