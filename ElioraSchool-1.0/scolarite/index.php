...
<img src='../images/icons/add.png' alt='' class='back_link' /> <a href="scolarite_tranches.php">Nouveau frais de scolarité</a>
</p>
<?php
...
$call_data = mysqli_query($GLOBALS["mysqli"], "SELECT * FROM classes, etg_fraisscolaire where (id_classe = id) ORDER BY classe");
...
if ($nombre_lignes != 0) {
	...
	while ($i < $nombre_lignes){
		...
		$Montant = old_mysql_result($call_data, $i, "montant");
		...
		echo "<td>\n";
		echo "<a href='scolarite_tranches.php?action=view&id_classe=$id_classe'> $Montant</a></td>\n";
