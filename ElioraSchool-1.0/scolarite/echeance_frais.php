...
<p class=bold><a href="../accueil_admin.php"<?php echo insert_confirm_abandon();?>><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Retour</a>
    ...
    | <a href='liste_payement.php'<?php echo insert_confirm_abandon();?>>Liste des payements</a>
	| <a href='recouvrement.php'<?php echo insert_confirm_abandon();?>>Recouvrement</a>
	<!--| <a href='echeance_frais.php'<?php echo insert_confirm_abandon();?>>Echéancier</a>
...
echo "<center><p class='grand'>Rechercher un élève</p></center>\n";
...
if (!isset($quelles_classes)) {
	...
	if($_SESSION['statut'] == 'professeur') {
		...
		echo "<form enctype='multipart/form-data' action='echeance_frais.php' method='post' name='formulaire'>\n";
...
*/
	...
	while ($i < $nombreligne){
		...
		if(($_SESSION['statut']=='administrateur')||($_SESSION['statut']=='scolarite')) {
			 echo "<td><p>";
           echo "<a href='echeance_definition.php?id_eleve=$id_eleve&el_login=$eleve_login&idclasse=$eleve_id_classe' >";
         //   echo "<span id='prof_suivi_$eleve_login'>";
            echo "Definir un écheancier";
            echo "</span>";
            echo "</a>";
            echo "</p></td>\n";
		}
