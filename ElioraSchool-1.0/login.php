...
if (version_compare(PHP_VERSION, '5') < 0) {
    die('ElioraScool nécessite PHP5 pour fonctionner');
}
...
// Vérification de la bonne installation de ElioraSchool
...
//Message
	if (isset($message)) {
		...
		$tbs_message[] =array("classe"=>"","texte" => "Afin d'utiliser ElioraSchool, vous devez vous identifier.");
	}
